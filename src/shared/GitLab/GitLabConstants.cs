...
namespace GitLab
{
    public record GitLabInstance
    {
        public GitLabInstance(string host, string oAuthClientId, string oAuthClientSecret)
        {
            Host = host;
    ...
    public static class GitLabConstants
    {
        ...
        private static readonly GitLabInstance[] GitLabInstances =
        {
            new GitLabInstance(host: "gitlab.com",
                // https://gitlab.com/oauth/applications/207177/edit,
            ...
            new GitLabInstance(host: "gitlab.freedesktop.org",
                // https://gitlab.freedesktop.org/oauth/applications/52
        ...
        public static readonly IDictionary<string, GitLabInstance> GitLabInstancesByHost = GitLabInstances.ToDictionary(x => x.Host, StringComparer.InvariantCultureIgnoreCase);
